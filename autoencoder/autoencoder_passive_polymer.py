...
for f in range(1, 6, 1):
    ...
    batch_size = 100
    epochs = 500
    checkpoint = tf.keras.callbacks.ModelCheckpoint(filepath=f"save_model_polymer_best/save_model_polymer_latent_dim_{latent_dim}_best.keras", monitor='val_loss', save_best_only=True, mode='max')
